...
def qud_rat(init_val, num):         #for reduce function
    return init_val + num ** 2

def qud_rat_map(num):      # for map function
    return num ** 2
...
print(reduce(qud_rat, numbers, 0)) #с помощью функции reduce
print(sum(map(qud_rat_map, numbers))) #с помощью map
